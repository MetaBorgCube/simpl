...
public class Program_1_Term extends IProgTerm 
{ 
  public final static String CONSTRUCTOR = "Program";

  public final static int ARITY = 1;

  public Program_1_Term (IExpTerm _1) 
  { 
    this._1 = _1;
  }
  ...
  public static Program_1_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new Program_1_Term(IExpTerm.create(term.getSubterm(0)));
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    Program_1_Term other = (Program_1_Term)obj;
    if(_1 == null)
    { 
      if(other._1 != null)
      { 
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isProgram_1_Term(obj);
             }
           };
  }
}