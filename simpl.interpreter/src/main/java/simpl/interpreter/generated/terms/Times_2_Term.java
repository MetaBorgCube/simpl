...
public class Times_2_Term extends IExpTerm 
{ 
  public final static String CONSTRUCTOR = "Times";

  public final static int ARITY = 2;

  public Times_2_Term (IExpTerm _1, IExpTerm _2) 
  { 
    this._1 = _1;
    this._2 = _2;
  }
  ...
  public static Times_2_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new Times_2_Term(IExpTerm.create(term.getSubterm(0)), IExpTerm.create(term.getSubterm(1)));
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    Times_2_Term other = (Times_2_Term)obj;
    if(_1 == null)
    { 
      if(other._1 != null)
      { 
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isTimes_2_Term(obj);
             }
           };
  }
}