...
import simpl.interpreter.generated.terms.App_2_Term;
...
public abstract class App_2_TermMatchPattern extends MatchPattern 
{ 
  @Child protected MatchPattern p_1;

  @Child protected MatchPattern p_2;

  public App_2_TermMatchPattern (SourceSection source, MatchPattern p_1, MatchPattern p_2) 
  { 
    super(source);
    this.p_1 = p_1;
    this.p_2 = p_2;
  ...
  @Specialization public boolean doMatch(App_2_Term term, VirtualFrame frame)
  { 
