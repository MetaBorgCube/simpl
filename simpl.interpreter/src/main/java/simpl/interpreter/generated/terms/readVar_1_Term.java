...
public class readVar_1_Term extends IreadVar__ArrowTerm 
{ 
  public final static String CONSTRUCTOR = "readVar";

  public final static int ARITY = 1;

  public readVar_1_Term (String _1) 
  { 
    this._1 = _1;
  }
  ...
  public static readVar_1_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new readVar_1_Term(Tools.stringAt(term, 0).stringValue());
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    readVar_1_Term other = (readVar_1_Term)obj;
    if(_1 == null)
    { 
      if(other._1 != null)
      { 
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isreadVar_1_Term(obj);
             }
           };
  }
}