...
public class Box_1_Term extends IExpTerm 
{ 
  public final static String CONSTRUCTOR = "Box";

  public final static int ARITY = 1;

  public Box_1_Term (IExpTerm _1) 
  { 
    this._1 = _1;
  }
  ...
  public static Box_1_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new Box_1_Term(IExpTerm.create(term.getSubterm(0)));
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    Box_1_Term other = (Box_1_Term)obj;
    if(_1 == null)
    { 
      if(other._1 != null)
      { 
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isBox_1_Term(obj);
             }
           };
  }
}