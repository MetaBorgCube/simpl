...
import simpl.interpreter.generated.terms.Let_3_Term;
...
public abstract class Let_3_TermMatchPattern extends MatchPattern 
{ 
  ...
  public Let_3_TermMatchPattern (SourceSection source, MatchPattern p_1, MatchPattern p_2, MatchPattern p_3) 
  { 
    super(source);
    this.p_1 = p_1;
    this.p_2 = p_2;
  ...
  @Specialization public boolean doMatch(Let_3_Term term, VirtualFrame frame)
  { 
