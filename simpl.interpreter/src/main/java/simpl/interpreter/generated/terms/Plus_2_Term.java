...
public class Plus_2_Term extends IExpTerm 
{ 
  public final static String CONSTRUCTOR = "Plus";

  public final static int ARITY = 2;

  public Plus_2_Term (IExpTerm _1, IExpTerm _2) 
  { 
    this._1 = _1;
    this._2 = _2;
  }
  ...
  public static Plus_2_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new Plus_2_Term(IExpTerm.create(term.getSubterm(0)), IExpTerm.create(term.getSubterm(1)));
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    Plus_2_Term other = (Plus_2_Term)obj;
    if(_1 == null)
    { 
      if(other._1 != null)
      { 
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isPlus_2_Term(obj);
             }
           };
  }
}