...
public class read_1_Term extends Iread__ArrowTerm 
{ 
  public final static String CONSTRUCTOR = "read";

  public final static int ARITY = 1;

  public read_1_Term (int _1) 
  { 
    this._1 = _1;
  }
  ...
  public static read_1_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new read_1_Term(Tools.intAt(term, 0).intValue());
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    read_1_Term other = (read_1_Term)obj;
    if(_1 != other._1)
    { 
      return false;
    }
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isread_1_Term(obj);
             }
           };
  }
}