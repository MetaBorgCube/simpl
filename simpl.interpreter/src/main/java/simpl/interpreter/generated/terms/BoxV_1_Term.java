...
public class BoxV_1_Term extends IVTerm 
{ 
  public final static String CONSTRUCTOR = "BoxV";

  public final static int ARITY = 1;

  public BoxV_1_Term (int _1) 
  { 
    this._1 = _1;
  }
  ...
  public static BoxV_1_Term create(IStrategoTerm term)
  { 
    CompilerAsserts.neverPartOfCompilation();
    assert term != null;
    assert Tools.isTermAppl(term);
    assert Tools.hasConstructor((IStrategoAppl)term, CONSTRUCTOR, ARITY);
    return new BoxV_1_Term(Tools.intAt(term, 0).intValue());
  }
  ...
  { 
    ...
    if(getClass() != obj.getClass())
      return false;
    BoxV_1_Term other = (BoxV_1_Term)obj;
    if(_1 != other._1)
    { 
      return false;
    }
  ...
  { 
    return new ITermInstanceChecker()
           { 
             ...
             { 
               return TypesGen.isBoxV_1_Term(obj);
             }
           };
  }
}